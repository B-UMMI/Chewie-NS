...
INSERT_SCHEMA = ('INSERT DATA IN GRAPH <{0}> '
                 ...
                 'typon:word_size "{10}"^^xsd:string; '
                 'typon:cluster_sim "{11}"^^xsd:string; '
                 'typon:representative_filter "{12}"^^xsd:string; '
                 'typon:intraCluster_filter "{13}"^^xsd:string; '
                 'typon:Schema_lock "{14}"^^xsd:string .}}')
...
SELECT_SPECIES_SCHEMA = ('SELECT ?schema '
                         ...
                         'typon:word_size ?word_size; typon:cluster_sim ?cluster_sim;'
