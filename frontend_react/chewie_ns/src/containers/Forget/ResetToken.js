...
class ResetToken extends Component {
  ...
  componentDidMount() {
    this.props.onSetAuthRedirectPath("/reset-password");
  }
      ...
      <Container component="main" maxWidth="xs">
        ...
        <div className={classes.paper}>
          ...
          <Typography component="h1" variant="h5">
            Provide the reset token to validate the reset password request.
          </Typography>
          <form
            ...
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <CssTextField
                  ...
                  name="token"
                  autoFocus
                  onInput={(e) => this.setState({ resetToken: e.target.value })}
                />
              </Grid>
            </Grid>
            <Button
